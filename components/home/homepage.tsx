          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20">
            ...
            <div className="border-border/80 lg:border-l lg:pl-16">
              ...
              <div className="mt-7 flex flex-wrap gap-x-8 gap-y-4 text-sm sm:text-base">
                ...
                <a href={`${siteConfig.githubUrl}#local-only-privacy`} target="_blank" rel="noopener noreferrer" aria-label="Read about local-only privacy on GitHub (opens in a new tab)" className="home-inline-link">No analytics &amp; local-only privacy</a>
                <a href={siteConfig.githubUrl} target="_blank" rel="noopener noreferrer" aria-label="Inspect the Markdown Lens source on GitHub (opens in a new tab)" className="home-inline-link">Open source</a>
              </div>
            </div>
          </div>
        </section>
